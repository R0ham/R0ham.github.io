...
export default {
  ...
  projects: [
    ...
    },
    {
      ...
      outcome: "Four pieces are included: two magnetic circles (stickered green and red) and two plastic housings. The magnetic circles are contained inside the plastic housings. And then the housings are affixed on both sides of the door (inside and outside of the bathroom, respectively) with easily removable adhesive. The small cutouts on either side indicate whether the bathroom is free (green) or busy (red). The intention is that a user can rotate to the color of their choice from inside the bathroom, which would simultaneously rotate both magnets.",
